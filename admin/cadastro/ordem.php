...
<div class="container">
	<h1 class="float-left">Cadastro de Ordem de Serviço</h1>
    ...
    <form action="salvar/ordem" method="post">
        <div class="row">
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                ...
                <input type="text" id="operacao" class="form-control" name="operacao" readonly value="2 - Ordem de Serviço">
            </div>
            <div class="col-md-2">
                <label for="codigo_ordem">ID</label>
                <input type="text" name="codigo_ordem" id="codigo_ordem"class="form-control" readonly value="<?=$id;?>">
            </div>
            <div class="col-md-6">
            ...
            <div class="tab-content" id="myTabContent">
              ...
              <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="produto-tab" style="background-color: #FDF5E6;">
                <div class="col-md-12 row" >
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="pquantidade" id="pquantidade" class="form-control" value="1" onblur="adicionar(this.value,1)">
                    </div>
                    <div class="col-md-3">
                        <label for="pvalor">Valor</label>
                        <input type="text" name="pvalor" id="pvalor" value="" class="form-control">
                    </div>
                    <div class="col-md-3">
                        <label for="psubtotal">SubTotal</label>
                        <input type="text" name="psubtotal" id="psubtotal" class="form-control" >
                    </div>
              ...
              <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="servico-tab" style="background-color: #FDF5E6;">
                    ...
                    <div class="col-md-3">
                        <label for="squantidade">Quantidade</label>
                        <input type="text" name="squantidade" id="squantidade" class="form-control" value="1" onfocus="adicionar(1,this.value)">
                    </div>
                    <div class="col-md-3">
                        <label for="svalor">Valor</label>
                        <input type="text" name="svalor" id="svalor" class="form-control">
                    </div>
                    <div class="col-md-3">
                        <label for="ssubtotal">SubTotal</label>
                        <input type="text" name="ssubtotal" id="ssubtotal" class="form-control" >
                    </div>
                    <div class="col-md-3">
            ...
            <div class="col-md-12 row">
                ...
                <div class="col-md-3">
                    <label for="descontototal">Desconto R$</label>
